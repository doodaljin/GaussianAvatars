...
from pipeline_stable_diffusion_grounded_instruct_pix2pix_dge import StableDiffusionInstructPix2PixDGEPipeline
import dlib
...
def edit(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from): 
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        if iteration % 30000 == 1:
            with torch.no_grad():
                batches = scene.getEditCamerasByTimestep()
